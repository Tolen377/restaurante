	    ...
	    <div class="header-options full-box">
	        <nav class="header-navbar full-box poppins-regular font-weight-bold" >
	            <ul class="list-unstyled full-box">
	                ...
	                <li>
	                    <a href="#" >Menú<span class="full-box" ></span></a>
	                </li>
					<li>
	                    <a href="ajax.php?action=logout" >Cerrar sesion<span class="full-box" ></span></a>
	                </li>
	            </ul>
	        </nav>
	            ...
	            <div class="div-bordered popup-login">
	                ...
	                <form id="login-form">
	                    <div class="form-outline mb-4">
	                        <input type="email" class="form-control" name="email" id="email" maxlength="70" required="" placeholder="Email" >
	                    </div>

	                    <div class="form-outline mb-4">
	                        <input type="password" id="password" class="form-control" name="password" id="login_password" maxlength="100" required="" placeholder="Contraseña" >
	                    </div>
